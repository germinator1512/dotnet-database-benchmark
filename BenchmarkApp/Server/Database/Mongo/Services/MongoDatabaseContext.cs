...
namespace BenchmarkApp.Server.Database.Mongo.Services
{
    public class MongoDatabaseContext
    {
        ...
        public IMongoCollection<MongoUserEntity> Users 
            => _database.GetCollection<MongoUserEntity>("users");

        public IMongoCollection<MongoUserEntity> WriteUsers
            => _database.GetCollection<MongoUserEntity>("writeUsers");
    }
}